...
export const addFavoritedCourseID = functions.https.onRequest(
  async (request, response) => {
    getCourseID(request, response, (courseID: string) => {
      validateReqAndGetUserInfo(
        request,
        response,
        async (userID: string, userInfoObj: UserInfo) => {
...
export const removeFavoritedCourseID = functions.https.onRequest(
  async (request, response) => {
    getCourseID(request, response, (courseID: string) => {
      validateReqAndGetUserInfo(
        request,
